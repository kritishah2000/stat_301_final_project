...
```{r}
patients_correlation <- data.matrix(patients_train, rownames.force = NA)
corrplot::corrplot(cor(patients_correlation),
                   type = "lower")
```


Bar Graph of Stay Categories Graph of severity of illness and visitors with patient (for step_interact)
